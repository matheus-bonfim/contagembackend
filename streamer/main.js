...
export const ports_path = './streamer/ports.json';
export const con_config_path = './streamer/containers_config';
          ...
          try {
              const container = await docker.createContainer({
                ...
                HostConfig: {
                  ...
                  Binds: [
                    `/home/wni/projeto/countPeople/streamer/containers_config/${containerName}.yml:/mediamtx.yml`, // Montando o arquivo de configuração
                  ],
                },
              });
